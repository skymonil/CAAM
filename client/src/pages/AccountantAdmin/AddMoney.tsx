...
function AddMoney() {
    ...
    const [students] = useState<Student[]>([
        { studentId: "S001", studentName: "Akshat", studentCourse: "BSCIT", walletBalance: 20000},
    ]);
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 shadow-lg shadow-gray-400 bg-white rounded-lg">
